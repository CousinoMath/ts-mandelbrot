...
onmessage = (evt) => {
    ...
    const points = evt.data[0];
    const [maxIters, escapeR] = evt.data[1];
    const imgData = evt.data[2];
...
function mandelbrot(points, maxIters, escapeR, imgData) {
    ...
    let iterHistogram = new Array(maxIters);
...
//# sourceMappingURL=mandelbrotWorker.js.map